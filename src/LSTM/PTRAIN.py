...
---------------------------------------------------------------------
Version: V1.8       Modified: 17.12.2024        William Siegle
------------------------------------------------------------------'''
...
CONFIG = {
    ...
    "MIN_SEQ_LENGTH":   602, # minimum sequence length in s to be included in DataSets
...
metrics = {
    ...
    "max_error": np.max(np.abs(all_y_true - all_y_pred))                      # Maximum Error
}
