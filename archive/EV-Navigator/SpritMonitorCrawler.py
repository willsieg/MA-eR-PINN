...
url = 'https://www.spritmonitor.de/en/detail/998377.html'
...
details = driver.find_element('id','vehicledetails')
vehicle = str(details.find_element('xpath','//h1').text)
...
while 1:
    ...
    try:
        table = driver.find_element('xpath',"//table[@class='itemtable']/tbody")
        rows = table.find_element('xpath',".//tr")
    ...
    for row in rows:
        features = row.find_element('xpath',".//td")
        ...
        if features[5].get_attribute(name="class") == "tire":
            try:
                tire_img = features[5].find_element('xpath',".//img")
        ...
        if features[6].get_attribute(name="class") == "street":
            try:
                street_imgs = features[6].find_element('xpath',".//img")
        ...
        if features[7].get_attribute(name="class") == "style":
            try:
                style_img = features[7].find_element('xpath',".//img")
        ...
        if features[10].get_attribute(name="class") == "fuelnote":
            try:
                fuel_note_imgs = features[10].find_element('xpath',".//img")
